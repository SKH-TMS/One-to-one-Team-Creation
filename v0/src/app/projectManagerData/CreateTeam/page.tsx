...
export default function CreateTeam() {
  ...
  // ✅ Handle checkbox selection for team members
  ...
  const handleCreateTeam = async () => {
    ...
    try {
      const response = await fetch("../../api/projectManagerData/createTeam", {
        ...
        body: JSON.stringify({
          ...
          teamLeader: {
            ...
            userId: teamLeader.userId, // ✅ Send only required data
          },
        }),
      });
      ...
      const data = await response.json();
      if (data.success) {
        alert("Team created successfully! Team Leader role updated.");
            ...
            <select
              ...
              className={`w-full p-3 border rounded-md focus:ring-2 ${
                selectedMembers.length <= 2
                  ...
                  : "border-gray-600 focus:ring-blue-500 text-red-500"
              }`}
            >
